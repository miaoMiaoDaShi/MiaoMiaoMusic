...
public class CoverLoader {
    ...
    public Bitmap loadThumbnail(Music music) {
        ...
        if (TextUtils.isEmpty(path)) {
            ...
            if (bitmap == null) {
                bitmap = BitmapFactory.decodeResource(AppCache.getContext().getResources(), xxp.xxp.music.R.drawable.default_cover);
    ...
    public Bitmap loadBlur(Music music) {
        ...
        if (TextUtils.isEmpty(path)) {
            ...
            if (bitmap == null) {
                bitmap = BitmapFactory.decodeResource(AppCache.getContext().getResources(), xxp.xxp.music.R.drawable.play_page_default_bg);
    ...
    public Bitmap loadRound(Music music) {
        ...
        if (TextUtils.isEmpty(path)) {
            ...
            if (bitmap == null) {
                bitmap = BitmapFactory.decodeResource(AppCache.getContext().getResources(), xxp.xxp.music.R.drawable.play_page_default_cover);
